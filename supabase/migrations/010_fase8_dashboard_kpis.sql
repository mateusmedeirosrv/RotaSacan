-- RotaScan — Fase 8: função de agregação para o Dashboard
-- Idempotente: pode ser executado múltiplas vezes sem erro.
--
-- SECURITY INVOKER (padrão): a função roda com os privilégios de quem
-- chama, então as policies de SELECT de bipagens/operacoes (RLS) seguem
-- isolando os dados por galpão automaticamente — gerente/colaborador não
-- precisam de filtro de galpão explícito; admin pode usar p_galpao_id.
